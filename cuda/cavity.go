...
// 	full_m: Normalized magnetization times Msat (m * Msat)
...
// see cavity.cu
func AddCavity(dst, full_m, brms, scn *data.Slice, wc, kappa MSlice, x0, p0, vc2_hbar, dt, ctime float64, mem *[2]float64, mesh *data.Mesh) {
